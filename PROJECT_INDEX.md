...
Markdown is the source of truth for controlled documentation. Word and PDF files are generated publication artefacts and must not become the only editable source.

## Naming policy

- Brand: **PicoT HEMS**
- Repository: `PicoT-HEMS`
- Technical namespace: `picot_hems.*`
