...
def adr037_dashboard_states(event: dict[str, object]) -> DashboardStates:
    ...
    attributes: dict[str, object] = {
        ...
        "zendure_configured_discharge_power_w": event.get("zendure_configured_discharge_power_w"),
        "zendure_configured_charge_power_w": event.get("zendure_configured_charge_power_w"),
        ...
        "flow_observer_tracking_deviation_w": event.get("flow_observer_tracking_deviation_w"),
        "flow_observer_raw_mismatch": event.get("flow_observer_raw_mismatch"),
        "flow_observer_persistent_mismatch": event.get("flow_observer_persistent_mismatch"),
        ...
        "flow_observer_consecutive_samples": event.get("flow_observer_consecutive_samples"),
        ...
        "flow_observer_battery_discharge_w": event.get("flow_observer_battery_discharge_w"),
        ...
        "canonical_price_opportunity_count": event.get("canonical_price_opportunity_count"),
        ...
        "price_window_best_later_starts_at": event.get("price_window_best_later_starts_at"),
        "price_window_best_later_price_eur_per_kwh": event.get("price_window_best_later_price_eur_per_kwh"),
        "requirement_energy_wh": event.get("adr037_requirement_energy_wh"),
        "requirement_protection_starts_at": event.get("adr037_requirement_protection_starts_at"),
        "requirement_protected_through": event.get("adr037_requirement_protected_through"),
        "remaining_charge_energy_wh": event.get("adr037_remaining_charge_energy_wh"),
        "additional_acquisition_required": event.get("adr037_additional_acquisition_required"),
        "latest_full_power_charge_start": event.get("adr037_latest_full_power_charge_start"),
    ...
    return {"sensor.picot_adr037_observer": {"state": state, "attributes": attributes}}
