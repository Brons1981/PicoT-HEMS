...
def test_mep_dashboard_exposes_baseline_market_and_authority_separately() -> None:
    ...
    assert view["native_observation_id"] == plan.native_observation.observation_id
...
def test_mep_runtime_dashboard_exposes_its_complete_native_plan() -> None:
